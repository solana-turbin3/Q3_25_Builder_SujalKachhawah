...
mod tests {
    use solana_sdk::{
        instruction::{AccountMeta, Instruction}, message::Message, signature::{read_keypair_file, Keypair, Signer}, system_program, transaction::Transaction
    };
    ...
    fn airdrop() {
        ...
        println!("Key length: {}", keypair.to_bytes().len());
    ...
    fn transfer_sol() {
        ...
        let to_pubkey = Pubkey::from_str("nD4Zq2ExoW8EroQ6AKUxu9DLqmBVtBphcoeiXgSqCc8").unwrap();
